module RedmineWysiwyg
  module ToolbarHelper
    ...
    def self.included(base)
      base.extend RedmineWysiwyg::ToolbarHelper
    end
    ...
    def configuration(*args)
      result = @@toolbar_config ||=
        YAML.load_file(RedmineWysiwyg::PLUGIN_DIR + '/config/toolbar.yml')
    ...
    def button_label(item, locale=I18n.locale)
      ...
      unless @@dict[locale]
        filename = RedmineWysiwyg::PLUGIN_DIR +
    ...
    def selected_items
      RedmineWysiwygSetting.toolbar.flatten 
    end
